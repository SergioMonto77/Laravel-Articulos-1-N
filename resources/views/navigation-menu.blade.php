<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    {{--SOLAMENTE SI ESTOY AUTENTICADO MOSTRARÉ LA BARRA DE NAVEGACIÓN (ya que en el show puedo entrar tanto autenticado como no)--}}
    @auth
                ...
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                            <i class="fa-solid fa-gears mr-2"></i> Gestionar artículos
                        </x-jet-nav-link>
                        <x-jet-nav-link href="{{ route('contacto.pintar') }}" :active="request()->routeIs('contacto.pintar')">
                            <i class="fa-solid fa-phone mr-2"></i> Contáctanos
                        </x-jet-nav-link>
                    </div>
                </div>
